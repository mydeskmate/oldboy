...
class Article(models.Model):
    ...
    blog = models.ForeignKey(verbose_name='所属博客', to='Blog',to_field='nid')
    category = models.ForeignKey(verbose_name='个人文章类型', to='Category',to_field='nid',null=True)
...
class Comment(models.Model):
    ...
    reply = models.ForeignKey(verbose_name='回复评论',to="self",related_name='back',null=True)         #self 表示自己
