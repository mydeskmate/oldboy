# Generated by Django 2.0.7 on 2018-08-11 02:42
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('article_type_id', models.IntegerField(choices=[(1, 'Python'), (2, 'Linux'), (3, 'OpenStack'), (4, 'Database')], default=None)),
            ],
        ),
        migrations.CreateModel(
            name='Article2Tag',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('nid', models.BigAutoField(primary_key=True, serialize=False)),
                ('title', models.CharField(max_length=255, verbose_name='评论内容')),
                ('create_time', models.DateTimeField(auto_now_add=True, verbose_name='创建时间')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_time', models.DateTimeField(auto_now_add=True, verbose_name='创建时间')),
                ('fans', models.ManyToManyField(related_name='f', through='app01.UserFans', to='app01.UserInfo', verbose_name='粉丝')),
            ],
        ),
        migrations.AddField(
            model_name='userfans',
        ...
        migrations.AddField(
            model_name='article',
            name='category',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='app01.Category', verbose_name='个人文章类型'),
        ),
        migrations.AddField(
            model_name='article',
            name='tag',
